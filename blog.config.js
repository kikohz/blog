...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'c79a757ddfee4d0dab268718deb15798',
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'nobelium', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','nobelium','matery'] @see https://preview.tangly1024.com
  ...
  AUTHOR: 'Fat uncle', // 作者
  BIO: '一个不胖的胖叔叔', // 作者简介
  LINK: 'https://llost.net', // 网站地址
  KEYWORDS: 'Notion, 博客,技术,人生,开发', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'kikohz@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'H_z2', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/kikohz', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/bllgo', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BACKGROUND_DARK: '#1d2025', // use hex value, don't forget '#'
  ...
  COMMENT_GISCUS_THEME_DARK:'https://unpkg.com/vuepress-theme-hope@next/templates/giscus/dark.css', // Giscus 夜间模式样式
  COMMENT_GISCUS_THEME_LIGHT:'https://unpkg.com/vuepress-theme-hope@next/templates/giscus/light.css', // Giscus 日间模式样式
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '胖叔叔不太胖', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'A fat uncle who is not too fat talks nonsense', // 站点描述，被notion中的页面描述覆盖
